...
class DeviceInfo {
    static func getDeviceInfo() -> [String: Any] {
        ...
        let deviceInfo: [String: Any] = [
            ...
            AppConstants.BATTERY_LEVEL: String(Int(batteryLevel)),
            AppConstants.SCREEN_BRIGHTNESS: String(Int(screenBrightness * 100)),
            AppConstants.VOLUME: String(Int(volume * 100)),
